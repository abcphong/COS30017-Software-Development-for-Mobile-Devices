...
class MainActivityTestThirdItem {
    ...
    fun mainActivityTestThirdItem() {
        ...
        val textView3 = onView(
            allOf(
                withId(R.id.instrumentName), withText("Drum Set"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
        ...
        textView3.check(matches(withText("Drum Set")))
        ...
        val textView4 = onView(
            allOf(
                withId(R.id.instrumentPrice), withText("Price: 60 credits"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
        ...
        textView4.check(matches(withText("Price: 60 credits")))
