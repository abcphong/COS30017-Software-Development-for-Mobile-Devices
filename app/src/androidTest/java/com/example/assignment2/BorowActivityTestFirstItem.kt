...
class BorowActivityTestFirstItem {
    ...
    @Test
    fun borowActivityTestFirstItem() {
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.borrowInstrumentName), withText("Electric Guitar"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
        ...
        textView2.check(matches(withText("Electric Guitar")))
        ...
        val textView4 = onView(
            allOf(
                withId(R.id.borrowInstrumentPrice), withText("Price: 50 credits"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
