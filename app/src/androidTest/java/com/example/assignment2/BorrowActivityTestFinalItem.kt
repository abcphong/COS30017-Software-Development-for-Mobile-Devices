...
class BorrowActivityTestFinalItem {
    ...
    @Test
    fun borrowActivityTestFinalItem() {
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.borrowInstrumentName), withText("Cello"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
        ...
        textView2.check(matches(withText("Cello")))
        ...
        val textView4 = onView(
            allOf(
                withId(R.id.borrowInstrumentPrice), withText("Price: 120 credits"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
        ...
        textView5.check(matches(withText("Price: 120 credits")))
