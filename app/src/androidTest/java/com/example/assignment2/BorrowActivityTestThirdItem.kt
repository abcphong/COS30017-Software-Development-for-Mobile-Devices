...
class BorrowActivityTestThirdItem {
    ...
    @Test
    fun borrowActivityTestThirdItem() {
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.borrowInstrumentName), withText("Drum Set"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
        ...
        textView2.check(matches(withText("Drum Set")))
        ...
        val textView4 = onView(
            allOf(
                withId(R.id.borrowInstrumentPrice), withText("Price: 60 credits"),
                withParent(
                    allOf(
                        withId(R.id.main),
                        withParent(withId(android.R.id.content))
